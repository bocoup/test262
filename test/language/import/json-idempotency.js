...
import viaStaticImport1 from './json-idempotency_FIXTURE.js' assert { type: 'json' };
import {default as viaStaticImport2} from './json-idempotency_FIXTURE.js' assert { type: 'json' };
...
import('./json-idempotency_FIXTURE.js', { assert: { type: 'json' } })
